...
import { courierRegisterAction } from "@/actions/register-actions/courierRegisterAction";
...
const CourierRegister = () => {
  ...
  const inputFields: InputFieldsProps[] = [
    ...
    },
    {
      name: "vehichle",
      type: "text",
      enterTitle: "Enter Your Vehichles",
      placeholder: "Car | Motorcycle",
      errors: state?.errors?.vehichle,
      defaultValue: state?.values.vehichle || "",
    },
    {
      name: "profilePicture",
      type: "file",
